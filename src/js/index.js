...
const searchInputE1 = document.querySelector('input[name="searchQuery]');
...
function renderGallery(hits) {
    const markup = hits
        ...
        galleryE1.insertAdjacentHTML('beforeend', markup);
...
async function handleSubmit(e) {
    e.preventDefault();
    options.params.q = searchInputE1.ariaValueMax.trim();
    if (options.param.q === ''){
        return;
    }
...
searchFormE1.addEventListener('submit', handleSubmit);
